...
public abstract class IntrospectedTable {
    ...
    protected enum InternalAttribute {
        ...
        ATTR_DELETE_BY_FIELDS_STATEMENT_ID,
        ATTR_REMOVE_BY_FIELDS_STATEMENT_ID,
        ATTR_SELECT_BY_FIELDS_STATEMENT_ID,
        ATTR_REMOVE_BY_PRIMARY_KEY_ID,
        ATTR_BASE_IF_CONDITION_STATEMENT_ID,
        ATTR_LOAD_PAGE_STATEMENT_ID
    }
    ...
    protected void calculateXmlAttributes() {
        ...
        setRemoveByFieldsStatementId("removeByFields");
        setRemoveByPrimaryKeyStatementId("removeByPrimaryKey");
        setDeleteByFieldsStatementId("deleteByFields");
        setSelectByFieldsStatementId("selectByFields");
        setBaseIfConditionStatementId("Base_If_Condition");
        setLoadPageStatementId("loadPage");
    }
    ...
    public void setDeleteByFieldsStatementId(String s) {
    	internalAttributes.put(InternalAttribute.ATTR_DELETE_BY_FIELDS_STATEMENT_ID, s);
    }
    
    public void setRemoveByFieldsStatementId(String s) {
    	internalAttributes.put(InternalAttribute.ATTR_REMOVE_BY_FIELDS_STATEMENT_ID, s);
    }
    
    public void setSelectByFieldsStatementId(String s) {
    	internalAttributes.put(InternalAttribute.ATTR_SELECT_BY_FIELDS_STATEMENT_ID, s);
    }
    
    public void setRemoveByPrimaryKeyStatementId(String s) {
    	internalAttributes.put(InternalAttribute.ATTR_REMOVE_BY_PRIMARY_KEY_ID, s);
    }
    
    public String getDeleteByFieldsStatementId() {
    	return internalAttributes.get(InternalAttribute.ATTR_DELETE_BY_FIELDS_STATEMENT_ID);
    }
    
    public String getRemoveByFieldsStatementId() {
    	return internalAttributes.get(InternalAttribute.ATTR_REMOVE_BY_FIELDS_STATEMENT_ID);
    }
    
    public String getSelectByFieldsStatementId() {
    	return internalAttributes.get(InternalAttribute.ATTR_SELECT_BY_FIELDS_STATEMENT_ID);
    }
    
    public String getRemoveByPrimaryKeyStatementId() {
    	return internalAttributes.get(InternalAttribute.ATTR_REMOVE_BY_PRIMARY_KEY_ID);
    }
    
    public void setBaseIfConditionStatementId(String s) {
    	internalAttributes.put(InternalAttribute.ATTR_BASE_IF_CONDITION_STATEMENT_ID, s);
    }
    
    public String getBaseIfConditionStatementId() {
    	return internalAttributes.get(InternalAttribute.ATTR_BASE_IF_CONDITION_STATEMENT_ID);
    }
    
    public void setLoadPageStatementId(String s) {
    	internalAttributes.put(InternalAttribute.ATTR_LOAD_PAGE_STATEMENT_ID, s);
    }
    
    public String getLoadPageStatementId() {
    	return internalAttributes.get(InternalAttribute.ATTR_LOAD_PAGE_STATEMENT_ID);
    }
