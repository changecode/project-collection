...
import org.mybatis.generator.codegen.mybatis3.xmlmapper.elements.BaseIfConditionElementGenerator;
...
import org.mybatis.generator.codegen.mybatis3.xmlmapper.elements.DeleteByFieldsElementGenerator;
...
import org.mybatis.generator.codegen.mybatis3.xmlmapper.elements.LoadPageElementGenerator;
import org.mybatis.generator.codegen.mybatis3.xmlmapper.elements.RemoveByFieldsElementGenerator;
import org.mybatis.generator.codegen.mybatis3.xmlmapper.elements.RemoveByPrimaryKeyElementGenerator;
...
import org.mybatis.generator.codegen.mybatis3.xmlmapper.elements.SelectByFieldsElementGenerator;
...
public class XMLMapperGenerator extends AbstractXmlGenerator {
    ...
    protected XmlElement getSqlMapElement() {
        ...
        // extends method lixx
        addRemoveByFieldsElement(answer);
        addRemoveByPrimaryKeyElement(answer);
        addDeleteByFieldsElement(answer);
        addSelectByFieldsElement(answer);
        addLoadPageElement(answer);
        addBaseIfConditionElement(answer);
    ...
    protected void addRemoveByFieldsElement(XmlElement parentElement) {
        AbstractXmlElementGenerator elementGenerator = new RemoveByFieldsElementGenerator();
        initializeAndExecuteGenerator(elementGenerator, parentElement);
    }
    
    protected void addRemoveByPrimaryKeyElement(XmlElement parentElement) {
        AbstractXmlElementGenerator elementGenerator = new RemoveByPrimaryKeyElementGenerator();
        initializeAndExecuteGenerator(elementGenerator, parentElement);
    }
    
    protected void addDeleteByFieldsElement(XmlElement parentElement) {
        AbstractXmlElementGenerator elementGenerator = new DeleteByFieldsElementGenerator();
        initializeAndExecuteGenerator(elementGenerator, parentElement);
    }
    
    protected void addSelectByFieldsElement(XmlElement parentElement) {
        AbstractXmlElementGenerator elementGenerator = new SelectByFieldsElementGenerator();
        initializeAndExecuteGenerator(elementGenerator, parentElement);
    }
    
    protected void addBaseIfConditionElement(XmlElement parentElement) {
        AbstractXmlElementGenerator elementGenerator = new BaseIfConditionElementGenerator();
        initializeAndExecuteGenerator(elementGenerator, parentElement);
    }
    
    protected void addLoadPageElement(XmlElement parentElement) {
        AbstractXmlElementGenerator elementGenerator = new LoadPageElementGenerator();
        initializeAndExecuteGenerator(elementGenerator, parentElement);
    }
