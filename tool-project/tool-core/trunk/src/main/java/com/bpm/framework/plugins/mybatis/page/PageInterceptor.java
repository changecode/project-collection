...
import com.bpm.framework.plugins.mybatis.interceptor.AbstractInterceptor;
import com.bpm.framework.plugins.mybatis.page.bean.PageBounds;
import com.bpm.framework.plugins.mybatis.page.bean.PageList;
import com.bpm.framework.plugins.mybatis.page.bean.Paginator;
import com.bpm.framework.plugins.mybatis.page.support.PropertiesHelper;
import com.bpm.framework.plugins.mybatis.page.support.SqlHelper;
...
public class PageInterceptor extends AbstractInterceptor {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -1306996793410191516L;
			...
			Callable<Paginator> countTask = new Callable() {
				public Object call() throws Exception {
					...
					if (cache != null && ms.isUseCache()
						...
						count = SqlHelper.getCount(ms, executor.getTransaction(),
